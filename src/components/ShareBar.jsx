      ...
      <div className="flex items-center gap-2">
        {SHARE_PLATFORMS.map(platform => (
          <a
            ...
            className="p-2 rounded-lg border border-slate-700/50 text-slate-400 hover:text-white hover:border-slate-600 transition-all hover:scale-110"
          >
            <platform.icon />
          </a>
        ))}
        {typeof navigator !== 'undefined' && navigator.share && (
          <button
            ...
            title="Share"
            className="p-2 rounded-lg border border-slate-700/50 text-slate-400 hover:text-amber-400 hover:border-amber-400/30 transition-all"
          >
            <Share2 size={14} />
          </button>
        )}
    ...
    <div className="bg-slate-800/30 border border-slate-700/30 rounded-xl p-4">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-slate-300">Share this page</span>
        </div>
        <div className="flex items-center gap-2">
          {SHARE_PLATFORMS.map(platform => (
            <a
              ...
              rel="noopener noreferrer"
              title={`Share on ${platform.name}`}
              className="p-2.5 rounded-lg border border-slate-700/50 text-slate-400 hover:text-white transition-all hover:scale-105"
